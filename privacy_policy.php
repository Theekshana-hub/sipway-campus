...
<title>Privacy Policy — Sipway Campus</title>
...
<header class="topbar">
 ...
 <a href="index.php" class="logo">
  ...
  <nav class="top-links">
    ...
    <a href="privacy_policy.php" class="current">Privacy Policy</a>
  </nav>
  <?php if ($isLoggedIn): ?>
 ...
 <a href="student_chat.php" class="nav-item">
  ...
  <main class="main">
    ...
    <div class="panel animate-up delay-1">
      <p class="intro">At Sipway Campus, we are committed to protecting your personal information. This Privacy Policy explains how we collect, use, store, and protect your data when you use our website and services.</p>

      <h2>1. Information We Collect</h2>
      <p>We may collect the following types of information:</p>
      <ul>
        <li><strong>Account information:</strong> Full name, email address, mobile number, preferred language, gender, address, and profile photo.</li>
        <li><strong>Payment information:</strong> Package selection, payment status, and transaction references (we do not store full card details).</li>
        <li><strong>Usage data:</strong> Session bookings, progress records, and interactions with the platform.</li>
      ...
      <ul>
        ...
        <li>To process package activations and payments</li>
        <li>To schedule sessions and match you with lecturers</li>
        <li>To send important notifications related to your account and bookings</li>
      ...
      <ul>
        <li>Lecturers (only what is necessary for conducting sessions)</li>
      ...
      <p>We use industry-standard measures to protect your data, including secure connections (HTTPS), access controls, and regular security reviews. However, no method of transmission over the internet is 100% secure.</p>

      <h2>5. Data Retention</h2>
      <p>We retain your personal information for as long as your account is active or as needed to provide services, comply with legal requirements, and resolve disputes.</p>
      ...
      <ul>
        ...
        <li>You may request correction or deletion of your data (subject to legal and operational requirements)</li>
        <li>You can contact us if you have concerns about how your data is handled</li>
      </ul>

      <h2>7. Cookies</h2>
      <p>We may use cookies and similar technologies to keep you logged in, remember preferences, and improve site performance. You can control cookies through your browser settings.</p>

      <h2>8. Children’s Privacy</h2>
      <p>Our services are intended for users aged 13 and above. If you are under 18, please use the platform with the guidance of a parent or guardian.</p>

      <h2>9. Changes to This Policy</h2>
      <p>We may update this Privacy Policy from time to time. Significant changes will be communicated through the platform. Continued use of Sipway Campus after updates constitutes acceptance of the revised policy.</p>

      <h2>10. Contact Us</h2>
      <p>If you have any questions about this Privacy Policy or how we handle your data, please reach out through the FAQs & Support section or the contact channels provided on the platform.</p>
    </div>
  </main>
</div>
    ...
    loginForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        if (result.success) {
          ...
          setTimeout(() => { window.location.href = 'privacy_policy.php'; }, 600);
        } else {
