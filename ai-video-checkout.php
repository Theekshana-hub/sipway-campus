...
// Fetch AI Video Package
$stmt = $conn->prepare("SELECT id, name, price, duration_days, description FROM ai_video_packages WHERE id = ? AND status = 'active' LIMIT 1");
...
$pkgTagLabel = 'AI VIDEO PACKAGE';
$durationLabel = !empty($package['duration_days']) ? $package['duration_days'] . ' Days Access' : 'Full Access';
...
<title>Checkout - <?php echo htmlspecialchars($package['name']); ?> | Sipway Campus</title>
...
<header class="topbar">
  <a href="practice-ai-video.php" class="logo">
    <span class="logo-mark">SC</span>
    <span>Sipway Campus</span>
  </a>
  <nav class="top-links">
    <a href="practice-ai-video.php">&larr; Back to AI Video Practice</a>
  </nav>
</header>

<div class="checkout-container">
  <div class="breadcrumb">
    <a href="practice-ai-video.php">AI Video Practice</a>
    <span>&rsaquo;</span>
    ...
    <div>
      <div class="summary-card">
        <div class="package-preview">
          ...
          <div class="pkg-title"><?php echo htmlspecialchars($package['name']); ?></div>
          <div class="pkg-sub"><?php echo htmlspecialchars($durationLabel); ?></div>
        </div>
        ...
        <form id="checkoutForm" method="GET" action="initiate-ai-video-payment.php">
...
function selectMethod(method) {
  ...
  if (method === 'bank') {
    ...
    form.action = 'upload-ai-video-bank-receipt.php';
  } else {
    submitBtn.innerHTML = '<span>Proceed to Secure Payment &rarr;</span>';
    form.action = 'initiate-ai-video-payment.php';
  }
}
</script>
